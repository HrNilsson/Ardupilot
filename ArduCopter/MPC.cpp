...
{
    dx[0][0] = _ahrs.roll -         old_x[0];
    dx[1][0] = _ahrs.get_gyro().x - old_x[1];
    dx[2][0] = _ahrs.pitch -        old_x[2];
    dx[3][0] = _ahrs.get_gyro().y - old_x[3];
    dx[4][0] = _ahrs.yaw -          old_x[4];
    dx[5][0] = _ahrs.get_gyro().z - old_x[5];

    old_x[0] = _ahrs.roll;
    old_x[1] = _ahrs.get_gyro().x;
    old_x[2] = _ahrs.pitch;
    old_x[3] = _ahrs.get_gyro().y;
    old_x[4] = _ahrs.yaw;
    old_x[5] = _ahrs.get_gyro().z;
